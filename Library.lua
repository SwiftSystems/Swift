--[[
    This is a modified version of Vision UI Lib v2 to fit my script's needs more.
    Original: https://github.com/Loco-CTO/UI-Library/tree/main/VisionLibV2
]]
...
function Library:Create(options)
	...
	function Gui:Tab(options)
		...
		function Tab:Section(options)
			...
			local Section = {Name = options.Name}
					...
					table.insert(
						...
						UserInputService.InputBegan:Connect(function(input, GameProcess)
							if input.UserInputType == Enum.UserInputType.Keyboard then
								if input.KeyCode == Keybind.Keybind and UserInputService:GetFocusedTextBox() == nil then
									pcall(function()
										options.Callback()
									end)
								end
	...
	do
		table.insert(
			ConnectionBin,
			UserInputService.InputBegan:Connect(function(input)
				if input.KeyCode == Gui.ToggleKey and UserInputService:GetFocusedTextBox() == nil then
